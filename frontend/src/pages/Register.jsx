...
import { CodeBracketSquareIcon, UserIcon, EnvelopeIcon, KeyIcon } from "@heroicons/react/24/outline";
          ...
          <div className="glass-panel p-6 sm:p-8 hover-lift w-full relative">
            ...
            >
              ...
              <div className="relative">
                <UserIcon className="w-5 h-5 text-[var(--text)] opacity-60 absolute left-4 top-1/2 -translate-y-1/2 pointer-events-none" />
                <input
                  type="text"
